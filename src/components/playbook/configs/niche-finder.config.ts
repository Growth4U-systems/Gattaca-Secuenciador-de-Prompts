    ...
    // =========================================
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Situaciones donde está tu cliente potencial (bebé, casamiento, divorcio...)',
          type: 'suggestion',
          executor: 'none',
          suggestionConfig: {
            generateFrom: 'api',
            apiEndpoint: '/api/niche-finder/life-contexts',
            allowAdd: true,
            allowEdit: true,
            minSelections: 1,
          },
        },
        {
          ...
          description: 'Necesidades del cliente que tu producto resuelve (cuenta, dinero, facturación...)',
          type: 'suggestion',
          executor: 'none',
          dependsOn: ['life_contexts'],
          suggestionConfig: {
            generateFrom: 'api',
            apiEndpoint: '/api/niche-finder/need-words',
            allowAdd: true,
            allowEdit: true,
            minSelections: 1,
          },
