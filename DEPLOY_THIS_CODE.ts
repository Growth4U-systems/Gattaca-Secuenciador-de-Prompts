// =====================================================
// SUPABASE EDGE FUNCTION: execute-flow-step
// Con Gemini 2.5 Pro - COPIA TODO ESTE ARCHIVO
// =====================================================
...
serve(async (req) => {
  ...
  try {
    ...
    // ========================================
    // LÍNEA CRÍTICA - GEMINI 2.5 PRO
    // ========================================
    const geminiApiKey = Deno.env.get('GEMINI_API_KEY') || Deno.env.get('GOOGLE_API_KEY')!
    const modelName = step_config.model || 'gemini-2.5-pro-002'  // ← MODELO CORRECTO
    // ========================================
